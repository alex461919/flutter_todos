...
class MaterialTodoAddPage extends HookWidget implements AutoRouteWrapper {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<TodoAddCubit, void>(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          if (_formKey.currentState!.validate()) {
            ...
            futureWithProgressAndModalError(context, cubit.addTodo(title: _title!, note: _note, date: _date!))
                .then((value) {
              if (context.router.stackData.length == 1) {
                context.router.replaceNamed('/');
              } else {
              ...
              return ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Успешно')));
            });
          }
        },
        tooltip: 'Сохранить',
