...
mixin _$TodoModel {
  ...
  int get date => throw _privateConstructorUsedError; // millisecondsSinceEpoch
...
abstract class $TodoModelCopyWith<$Res> {
  ...
  $Res call({String title, int date, String state, String? id, String? note});
}
...
class _$_TodoModel implements _TodoModel {
  ...
  @override
  final int date;
  @override // millisecondsSinceEpoch
  final String state;
  @override
  final String? id;
  @override
  ...
  @override
  String toString() {
    return 'TodoModel(title: $title, date: $date, state: $state, id: $id, note: $note)';
  }
